...
router.get(
  ...
  CashoutRequestController.viewAllCashoutRequestServices,
);
...
router.patch(
  ...
  singleFileUpload,
  ValidationMiddleware.validate(ValidationMiddleware.schema.CashoutRequest),
  CashoutRequestController.updateCashoutRequestService,
);
