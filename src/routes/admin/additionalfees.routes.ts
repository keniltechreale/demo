...
router.post(
  ...
  ValidationMiddleware.validate(ValidationMiddleware.schema.AdditionalFee),
  AdditionalFeesController.addAdditionalFee,
);
...
router.patch(
  ...
  AuthGuard.verifyAdminAccessToken,
  ValidationMiddleware.validate(ValidationMiddleware.schema.AdditionalFee),
  AdditionalFeesController.updateAdditionalFee,
);

router.delete(
  '/:id',
  AuthGuard.verifyAdminAccessToken,
  AdditionalFeesController.deleteAdditionalFee,
);
