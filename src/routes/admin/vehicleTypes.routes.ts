...
router.post(
  ...
  singleFileUpload,
  ValidationMiddleware.validate(ValidationMiddleware.schema.VehicleTypes),
  VehicleTypesController.addVehicleTypes,
);
...
router.patch(
  ...
  singleFileUpload,
  ValidationMiddleware.validate(ValidationMiddleware.schema.VehicleTypes),
  VehicleTypesController.updateVehicleTypes,
);

router.delete(
  '/:type_id',
  AuthGuard.verifyAdminAccessToken,
  VehicleTypesController.deleteVehicleTypes,
);
