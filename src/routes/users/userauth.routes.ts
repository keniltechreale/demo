...
router.patch(
  '/change/password',
  AuthGuard.verifyUserAccessToken,
  ValidationMiddleware.validate(ValidationMiddleware.schema.ChangePassword),
  AuthController.changePassword,
);

router.post(
  '/forgot/password',
  ValidationMiddleware.validate(ValidationMiddleware.schema.UserForgotPassword),
