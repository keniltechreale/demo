...
router.post(
  ...
  ValidationMiddleware.validate(ValidationMiddleware.schema.Rides),
  RidesController.addRides,
);
...
router.patch(
  '/:ride_id',
  AuthGuard.verifyUserAccessToken,
  upload.single('mapScreenshot'),
  singleFileUpload,
  ValidationMiddleware.validate(ValidationMiddleware.schema.UpdateRides),
  RidesController.updateRides,
);
