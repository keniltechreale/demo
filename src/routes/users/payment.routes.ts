...
router.post(
  '/proxypay/initialize/:ride_id',
  AuthGuard.verifyUserAccessToken,
  ValidationMiddleware.validate(ValidationMiddleware.schema.Payment),
  PaymentController.initializeProxyPayPayment,
);
...
router.get(
  '/proxypay/verify/:reference',
  AuthGuard.verifyUserAccessToken,
  PaymentController.verifyProxyPayPayment,
);

router.post(
  '/proxypay/wallet-topup',
  AuthGuard.verifyUserAccessToken,
  PaymentController.initializeWalletTopUp,
);
