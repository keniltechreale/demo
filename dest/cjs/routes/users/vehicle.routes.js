...
const vehicle_controller_1 = __importDefault(require("../../controller/users/vehicle.controller"));
...
const fileMiddleware_1 = require("../../lib/fileMiddleware");
 ...
 */
router.post('/', AuthGuard.verifyUserAccessToken, fileMiddleware_1.uploadFunction, fileUpload_utils_1.multipleFileUpload, validation_middleware_1.default.validate(validation_middleware_1.default.schema.Vehicle), vehicle_controller_1.default.addVehicle);
/**
 * @swagger
 * /api/v1/vehicles:
 *   get:
 ...
 *               message: "Unauthorized access"
 */
router.get('/', AuthGuard.verifyUserAccessToken, vehicle_controller_1.default.viewVehicles);
/**
 * @swagger
 ...
 */
router.patch('/:vehicle_id', AuthGuard.verifyUserAccessToken, fileMiddleware_1.uploadFunction, fileUpload_utils_1.multipleFileUpload, validation_middleware_1.default.validate(validation_middleware_1.default.schema.UpdateVehicle), vehicle_controller_1.default.updateVehicle);
/**
 * @swagger
 * /api/v1/vehicles/{vehicle_id}:
 *   delete:
 ...
 *                   message: "User not found"
 */
router.delete('/:vehicle_id', AuthGuard.verifyUserAccessToken, vehicle_controller_1.default.deleteVehicle);
