 ...
 */
router.get('/:type', AuthGuard.verifyAdminAccessToken, legalcontent_controller_1.default.viewLegalContent);
/**
 * @swagger
 * /api/v1/admin/legalcontent/{type}:
 *   patch:
 ...
 *         description: Internal server error
 */
router.patch('/:type', AuthGuard.verifyAdminAccessToken, validation_middleware_1.default.validate(validation_middleware_1.default.schema.LegalContent), legalcontent_controller_1.default.UpdateLegalContent);
