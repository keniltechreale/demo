...
const faqs_service_1 = __importDefault(require("../../services/admin/faqs.service"));
...
exports.default = new (class FAQsController {
    constructor() {
        this.addFAQs = (req, res) => {
            try {
                const body = req.body;
                faqs_service_1.default.addFAQs(body)
                    .then((result) => {
        ...
        this.viewAllFAQs = (req, res) => {
            try {
                ...
                faqs_service_1.default.getAllFAQs(args)
                    .then((result) => {
                    res.status(Utils.statusCode.OK).send(Utils.sendSuccessResponse(result));
                })
                    .catch((err) => {
        ...
        this.updateFAQs = (req, res) => {
            try {
                const body = req.body;
                faqs_service_1.default.updateFAQs(body, req.params.faqs_id)
                    .then((result) => {
                    res.status(Utils.statusCode.OK).send(Utils.sendSuccessResponse(result));
                })
                    .catch((err) => {
        ...
        this.deleteFAQs = (req, res) => {
            try {
                ...
                faqs_service_1.default.deleteFAQs(args)
                    .then((result) => {
                    res.status(Utils.statusCode.OK).send(Utils.sendSuccessResponse(result));
                })
                    .catch((err) => {
