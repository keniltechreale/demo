...
const referral_service_1 = __importDefault(require("../../services/admin/referral.service"));
const pagination_config_1 = __importDefault(require("../../config/pagination.config"));
exports.default = new (class ReferralController {
    constructor() {
        // Get all referrals
        this.viewAllReferrals = (req, res) => {
            try {
                ...
                referral_service_1.default.getAllReferrals(args)
                    .then((result) => {
        ...
        this.updateReferral = (req, res) => {
            try {
                ...
                referral_service_1.default.updateReferral(body, referralId)
                    .then((result) => {
                    res.status(Utils.statusCode.OK).send(Utils.sendSuccessResponse(result));
                })
                    .catch((err) => {
        ...
        this.deleteReferral = (req, res) => {
            try {
                const referralId = req.params.referral_id;
                referral_service_1.default.deleteReferral({ referralId })
                    .then((result) => {
                    res.status(Utils.statusCode.OK).send(Utils.sendSuccessResponse(result));
                })
                    .catch((err) => {
