...
const blogs_service_1 = __importDefault(require("../../services/admin/blogs.service"));
...
exports.default = new (class BlogController {
    constructor() {
        this.addBlog = (req, res) => {
            try {
                const body = req.body;
                blogs_service_1.default.addBlogs(body)
                    .then((result) => {
        ...
        this.viewAllBlogs = (req, res) => {
            try {
                ...
                blogs_service_1.default.getAllBlogs(args)
                    .then((result) => {
                    res.status(Utils.statusCode.OK).send(Utils.sendSuccessResponse(result));
                })
                    .catch((err) => {
        ...
        this.updateBlog = (req, res) => {
            try {
                const body = req.body;
                blogs_service_1.default.updateBlogs(body, req.params.blog_id)
                    .then((result) => {
                    res.status(Utils.statusCode.OK).send(Utils.sendSuccessResponse(result));
                })
                    .catch((err) => {
        ...
        this.deleteBlog = (req, res) => {
            try {
                ...
                blogs_service_1.default.deleteBlogs(args)
                    .then((result) => {
                    res.status(Utils.statusCode.OK).send(Utils.sendSuccessResponse(result));
                })
                    .catch((err) => {
