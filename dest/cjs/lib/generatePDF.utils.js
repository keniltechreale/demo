...
exports.createRideEmailPdf = exports.createWeeklyStatementPdf = void 0;
...
pdfmake_1.default.vfs = vfsFonts.pdfMake.vfs;
...
function createWeeklyStatementPdf(totalAmountUntilStart, totalAmountUntilEnd, totalAmountExpenses, user, transactions) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const imageUrls = [
...
exports.createWeeklyStatementPdf = createWeeklyStatementPdf;
function createRideEmailPdf(user, rideDetails) {
    return __awaiter(this, void 0, void 0, function* () {
                            ...
                            { text: 'Ride Duration', alignment: 'left', fontSize: 17 },
                            {
                                text: `${rideDetails.durationInmins >= 60
                                    ? moment_timezone_1.default
                                        .utc(moment_timezone_1.default.duration(rideDetails.durationInmins, 'minutes').asMilliseconds())
                                        .format('H [hr], m [min]')
                                    : moment_timezone_1.default
                                        .utc(moment_timezone_1.default.duration(rideDetails.durationInmins, 'minutes').asMilliseconds())
                                        .format('m [min]')}`,
...
exports.createRideEmailPdf = createRideEmailPdf;
