...
export function sendDocumentVerificationMail(user, verificationStatus) {
...
export function sendContactUsMail(email, content) {
    return __awaiter(this, void 0, void 0, function* () {
        const transporterOptions = {
            host: emailConfig.emailHost,
            port: Number(emailConfig.emailPort),
...
export function sendRideCompletionMail(user, content) {
    return __awaiter(this, void 0, void 0, function* () {
        const transporterOptions = {
            host: emailConfig.emailHost,
            port: Number(emailConfig.emailPort),
        ...
        const pdfBuffer = yield createRideEmailPdf(user, content);
        const transporter = nodemailer.createTransport(transporterOptions);
        const mailOptions = {
            from: emailConfig.emailUser,
            to: user.email,
...
export function sendCashOutRequest(email, content) {
    return __awaiter(this, void 0, void 0, function* () {
        const transporterOptions = {
            host: emailConfig.emailHost,
            port: Number(emailConfig.emailPort),
...
export function sendCareerApplicationMail(args) {
    return __awaiter(this, void 0, void 0, function* () {
        const transporterOptions = {
            host: emailConfig.emailHost,
            port: Number(emailConfig.emailPort),
