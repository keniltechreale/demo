...
router.post('/contact/us', ValidationMiddleware.validate(ValidationMiddleware.schema.ContactUs), MiscController.addContactUsData);
router.post('/career/apply', upload.single('resume'), singleFileUpload, ValidationMiddleware.validate(ValidationMiddleware.schema.CareerApplication), MiscController.applyForCareer);
