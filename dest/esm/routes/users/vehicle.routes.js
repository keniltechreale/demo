 ...
 */
router.post('/', AuthGuard.verifyUserAccessToken, uploadFunction, multipleFileUpload, ValidationMiddleware.validate(ValidationMiddleware.schema.Vehicle), VehicleController.addVehicle);
/**
 * @swagger
 * /api/v1/vehicles:
 *   get:
 ...
 */
router.patch('/:vehicle_id', AuthGuard.verifyUserAccessToken, uploadFunction, multipleFileUpload, ValidationMiddleware.validate(ValidationMiddleware.schema.UpdateVehicle), VehicleController.updateVehicle);
/**
 * @swagger
 * /api/v1/vehicles/{vehicle_id}:
 *   delete:
