...
router.post('/transfer/:user_id', AuthGuard.verifyUserAccessToken, ValidationMiddleware.validate(ValidationMiddleware.schema.TransferFunds), WalletsController.transferFunds);
router.post('/payment/:ride_id', AuthGuard.verifyUserAccessToken, WalletsController.walletPayment);
router.post('/tip/payment/:ride_id', AuthGuard.verifyUserAccessToken, ValidationMiddleware.validate(ValidationMiddleware.schema.TransferFunds), WalletsController.WalletTipPayment);
