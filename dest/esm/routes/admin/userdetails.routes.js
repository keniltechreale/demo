...
// );
router.patch('/:user_id', AuthGuard.verifyAdminAccessToken, ValidationMiddleware.validate(ValidationMiddleware.schema.UpdateDriverAcc), UserController.updateUser);
router.patch('/vehicle/:vehicle_id', AuthGuard.verifyAdminAccessToken, ValidationMiddleware.validate(ValidationMiddleware.schema.AdminUpdateVehicle), UserController.updateVehicle);
router.get('/vehicles/:user_id', AuthGuard.verifyAdminAccessToken, UserController.viewVehicles);
router.get('/payment/history/:user_id', AuthGuard.verifyAdminAccessToken, UserController.paymentHistory);
